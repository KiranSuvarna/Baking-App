...
import static com.imkiran.bakingapp.widget.UpdateBakingService.FROM_ACTIVITY_INGREDIENTS_LIST;
...
public class BakingWidget extends AppWidgetProvider {
    ...
    static ArrayList<String> ingredientsArrayList = new ArrayList<>();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals("android.appwidget.action.APPWIDGET_UPDATE2")) {
            ingredientsArrayList = intent.getExtras().getStringArrayList(FROM_ACTIVITY_INGREDIENTS_LIST);
